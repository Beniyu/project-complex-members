...
class Optimise:
    def __init__(self):
        ...
        self.connections = [[1,2], [2,3], [4,5], [5,3], [2,5], [2,4]]
        self.constraints = {1: 'x', 4:'xy'}
        self.loads = [{3:[0,-1320,0]}, {3:[0,132,0]}]
    ...
    def randomize(self, points = (), random_factor = 250000000000):
        ...
        for i in range(10000):
            ...
            for point_num in [1]:
                ...
                if new_point_x >= 815:
                    new_point_x = 814.999
                new_point_y = points_copy[2][1] * new_point_x / 815
                new_point = [new_point_x, new_point_y]
                points_copy[point_num] = new_point
            ...
            for point_num in [4]:
                ...
                if new_point_x >= 815:
                    new_point_x = 814.999
                new_point_y = 255 - (255 - points_copy[2][1]) * new_point_x / 815
                new_point = [new_point_x, new_point_y]
                points_copy[point_num] = new_point
