...
class Optimise:
    def __init__(self):
        print("Let's begin!")
        self.points = [[0,0], [815/4,0], [815/2,0], [815*3/4,0], [815,0], [0,255], [815/3,255*2/3], [815*2/3, 255/3]]
        self.connections = [[1,2], [2,3], [3,4], [4,5], [6,7], [7,8], [8,5], [4,8], [8,3], [2,6], [2,7],[7,3]]
