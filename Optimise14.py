    ...
    def randomize(self, points = (), random_factor = 256000000000):
        ...
        for i in range(5000):
            ...
            for point_num in [1,2]:
                ...
                if new_point_x >= 815:
                    new_point_x = 814.999
                #new_point_y = new_point_x * points_copy[3][1]/815
                new_point_y = point[1]
                new_point = [new_point_x, new_point_y]
                points_copy[point_num] = new_point
            ...
            try:
                ...
                point_4 = np.array(points_copy[4])
                point_5 = np.array(points_copy[5])
                top_length = np.linalg.norm(point_5 - point_4)
                ...
                if total_mass < top_mass and top_length <= 380 and (left_bar == middle_bar or middle_bar == right_bar):
                    top_mass = total_mass
                    top_config = {
                        'points': points_copy,
