...
class Optimise:
    def __init__(self):
        print("Let's begin!")
        self.points = [[0, 0], [270, 35], [490, 35], [815, 85], [0, 255], [405, 215]]
    ...
    def randomize(self, points = (), random_factor = 32000000000):
        ...
        top_config = {}
        point_2_x = -5
        for point_1_x in range(-15, 20, 5):
            for point_3_y in range(-15, 20, 5):
                for point_1_y in range(-15, 20, 5):
                    for point_5_x in range(-15, 20, 5):
                        for point_5_y in range(-15, 20, 5):
                            points_copy = points.copy()
                            points_copy[3] = [815, round(points[3][1]) + point_3_y]
                            points_copy[1] = [round(points[1][0]) + point_1_x, round(points[1][1]) + point_1_y]
                            points_copy[2] = [round(points[2][0]) + point_2_x, round(points[2][1]) + point_1_y]
