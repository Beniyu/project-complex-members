...
class Optimise:
    def __init__(self):
        print("Let's begin!")
        self.points = [[0,0], [815/3,0], [815*2/3,0], [815,0], [0,255], [815/3,255/3*2], [815/3*2,255/3]]
        self.connections = [[1,2], [2,3], [3,4], [5,6], [6,7], [3,7], [2,6], [3,6], [5,2],[7,4]]
    ...
    def randomize(self, points = (), random_factor = 250000000000):
        ...
        for i in range(20000):
            ...
            for point_num in [1]:
                ...
                if new_point_x >= 815:
                    new_point_x = 814.999
                new_point_y = points_copy[2][1] * new_point_x / points_copy[2][0]
                new_point = [new_point_x, new_point_y]
                points_copy[point_num] = new_point
            ...
            for point_num in [5]:
                ...
                if new_point_x >= 815:
                    new_point_x = 814.999
                new_point_y = 255 - (255 - points_copy[6][1]) * new_point_x / points_copy[6][0]
                new_point = [new_point_x, new_point_y]
                points_copy[point_num] = new_point
