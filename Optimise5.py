...
class Optimise:
    def __init__(self):
        print("Let's begin!")
        self.points = [[0,0], [815/4,0], [815/2,0], [815*3/4,0], [0,255], [815/4,255*3/4], [815/2,255/2], [815,0]]
        self.connections = [[1,2], [2,3], [3,4], [4,8], [5,6], [6,7], [7,8], [3,7], [2,6], [3,6], [5,2], [7,4]]
        self.constraints = {1: 'x', 5:'xy'}
        self.loads = [{8:[0,-1320,0]}, {8:[0,132,0]}]
    ...
    def randomize(self, points = (), random_factor = 250000000000):
        ...
        for i in range(10000):
            ...
            for point_num in [1,2,3]:
                ...
                if new_point_x >= 815:
                    new_point_x = 814.999
                new_point_y = points_copy[7][1] * new_point_x / 815
                new_point = [new_point_x, new_point_y]
                points_copy[point_num] = new_point

            for point_num in [5,6]:
                point = points_copy[point_num]
                new_point_x = point[0] + random.randint(-random_factor,random_factor) / 1000000000
                if new_point_x <= 0:
                    new_point_x = 0.001
                if new_point_x >= 815:
                    new_point_x = 814.999
                new_point_y = 255 - (255 - points_copy[7][1]) * new_point_x / 815
                new_point = [new_point_x, new_point_y]
                points_copy[point_num] = new_point
